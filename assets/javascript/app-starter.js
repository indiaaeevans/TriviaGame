...
var q = [
    ...
    new triviaQuestion('Which color model represents additive color?', ['RGB', 'CMYK', 'RYB', 'ROYGBV'], 0),
    new triviaQuestion('With <span class="strong">additive color</span>, the more light you add, the ____ the color mix becomes.', 
        ['darker', 'brighter'], 1),
    // new triviaQuestion('TVs, screens and projectors use ___ as their primary colors,and then mix them together to create other colors.',
    ...
    //     ['true', 'false'], 0),
    // new triviaQuestion('Printers use ____ inks to create colors.', 
    //     ['red, green, blue, black', 'red, yellow, blue, black', 'cyan, yellow, magenta, black', 'ROYGBV'], 2),
    ...
    // new triviaQuestion('Which of the following is an example of a <span class="strong">tertiary color?</span>', 
    //     ['orange', 'blue-green', 'violet', 'white'], 1),
    // new triviaQuestion('Which of the following is considered a warm color?', ['purple', 'yellow', 'blue', 'green'], 1),
    // new triviaQuestion('____ colors are opposites on the color wheel (red and green, for example).  ___ colors sit next to one another on the color wheel.', 
    //     ['Complementary / Analogous', 'Analogous / Complementary', 'None of the above'], 0),
    // new triviaQuestion('____ colors are evenly spaced around the color wheel.', ['Monochrome', 'Harmonious’, ‘Triadic'], 2)
];
